...
/**
 * Ventana para la creación de seguimientos médicos y solicitud de exámenes.
 * Permite buscar pacientes, crear nuevos seguimientos y solicitar exámenes.
 */
public class VentanaCreacion extends JFrame {
    ...
    public VentanaCreacion() {
        ...
        getContentPane().add(lblBPaciente);
