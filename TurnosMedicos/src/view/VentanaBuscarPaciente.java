...
public class VentanaBuscarPaciente extends JFrame {
	...
	public VentanaBuscarPaciente() {
		...
		lblLogo = new JLabel("");
		lblLogo.setIcon(new ImageIcon(VentanaBuscarPaciente.class.getResource("/view/—Pngtree—medical logo_3558939 (1).png")));
		...
		lblBackground.setIcon(new ImageIcon(VentanaBuscarPaciente.class.getResource("/view/pexels-francesco-ungaro-281260 (2).jpg")));
